...
class PottedDetail: UIViewController {
    ...
    var product = Product(name: "product 1", title: "product title", desc: "product description", price: 100.00 ,category: "product category",picURL:"load3",key: "key")
