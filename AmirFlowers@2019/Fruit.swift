...
class Fruit: UIViewController ,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func loadDB() {
        dbRef.queryOrdered(byChild: "category").queryEqual(toValue: "פירות").observeSingleEvent(of: DataEventType.value) { (snapshot) in
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.audioPlayer?.play()
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        if let v = storyboard.instantiateViewController(withIdentifier: "FruitDetail") as? FruitDetail {
